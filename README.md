...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/gentle-mud-89ef)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/gentle-mud-89ef#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/gentle-mud-89ef
```

A live public deployment of this template is available at [https://gentle-mud-89ef.templates.workers.dev](https://gentle-mud-89ef.templates.workers.dev)
